...
public class MonotoneTravelTest
{
    ...
    {
        Assert.That(MonotoneTravel.IsMonotone(new int[] { 5, 5, 5, 5, 5 }), Is.True);
    }

    [Test, Order(3), Description("should work on an empty list")]
    public void EmptyTest()
    {
        Assert.That(MonotoneTravel.IsMonotone(new int[] { }), Is.True);
    }
    ...
    {
        Assert.That(MonotoneTravel.IsMonotone(new int[] { 1, 2, 3, 3, 4, 5 }), Is.True);
    }
}
